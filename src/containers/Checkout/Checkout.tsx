        ...
        <CheckoutContainer>
          <OrderSummary>
            <OrderSummaryItem style={{ marginBottom: 15 }}>
              <OrderLabel>
                <FormattedMessage id="subTotal" defaultMessage="Subtotal" /> ({cartItemsCount}{' '}
            ...
            <OrderSummaryItem style={{ marginBottom: 30 }}>
              <OrderLabel>
                <FormattedMessage id="shippinFeeText" defaultMessage="Shipping Fee" />
              </OrderLabel>
              <OrderAmount>$ 00</OrderAmount>
            </OrderSummaryItem>

            <OrderSummaryItem style={{ marginBottom: 30 }} className="voucherWrapper">
              <OrderLabel>
          ...
          <DeliveryAddress>
            <Heading>
              <FormattedMessage id="checkoutDeliveryAddress" defaultMessage="Select Your Delivery Address" />
            </Heading>
            <ButtonGroup>
              <RadioGroup
                items={address}
