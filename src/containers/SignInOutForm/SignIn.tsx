    ...
    <Wrapper>
      <Container>
        ...
        <form onSubmit={loginCallback}>
          <FormattedMessage id="emailAddressPlaceholder" defaultMessage="Email Address.">
            {(placeholder) => (
              <Input
                type="email"
          ...
          <Button fullwidth title={'Continue'} intlButtonId="continueBtn" type="submit" style={{ color: '#fff' }} />
        </form>
        <Divider>
          <span>
        ...
        <Offer style={{ padding: '20px 0' }}>
          <FormattedMessage id="dontHaveAccount" defaultMessage="Don't have any account?" />{' '}
      ...
      <OfferSection>
        <Offer>
          <FormattedMessage id="forgotPasswordText" defaultMessage="Forgot your password?" />{' '}
