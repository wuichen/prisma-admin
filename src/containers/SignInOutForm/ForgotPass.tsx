  ...
  return (
    <Wrapper>
      <Container style={{ paddingBottom: 30 }}>
        ...
        <Heading>
          <FormattedMessage id="forgotPassText" defaultMessage="Forgot Password" />
        </Heading>

        <SubHeading>
          <FormattedMessage id="sendResetPassText" defaultMessage="We'll send you a link to reset your password" />
        </SubHeading>
        ...
        <Button fullwidth title={'Reset Password'} intlButtonId="resetPasswordBtn" style={{ color: '#fff' }} />
