      ...
      <SettingsFormContent>
        ...
        <Row style={{ alignItems: 'flex-end', marginBottom: '50px' }}>
          ...
          <Col xs={12} sm={2} md={2} lg={2}>
            <Button title="Save" onClick={handleSave} style={{ width: '100%' }} intlButtonId="profileSaveBtn" />
          </Col>
        </Row>
        <Row>
          <Col xs={12} sm={12} md={12} lg={12}>
            <SettingsFormContent>
              <HeadingSection>
                <Title>
                  <FormattedMessage id="contactNumberTItle" defaultMessage="Contact Numbers" />
                </Title>
              </HeadingSection>
              <ButtonGroup>
                <RadioGroup
        ...
        <Row>
          <Col xs={12} sm={12} md={12} lg={12} style={{ position: 'relative' }}>
            <SettingsFormContent>
              <HeadingSection>
                <Title>
                  <FormattedMessage id="deliveryAddresTitle" defaultMessage="Delivery Address" />
                </Title>
              </HeadingSection>
              <ButtonGroup>
                <RadioGroup
        ...
        <Row>
          <Col xs={12} sm={12} md={12} lg={12}>
            <SettingsFormContent>
              <HeadingSection>
                <Title>
                  <FormattedMessage id="paymentCardTitle" defaultMessage="Payments Card" />
                </Title>
              </HeadingSection>
              <PaymentGroup
                name="payment"
                ...
                handleAddNewCard={() => {
                  handleModal(StripePaymentForm, { buttonText: 'Add Card' }, 'add-address-modal stripe-modal');
                }}
              />
            </SettingsFormContent>
          </Col>
