    ...
    <>
      <ProductDetailsWrapper className="product-card">
        <ProductPreview>
          ...
          <img src={product.gallery[0]} alt={product.title} className="product-image" />
        </ProductPreview>
        ...
        <ProductInfo>
          ...
          <BookDescriptionWrapper>
            <BookDescription>
              ...
              <a href="#" onClick={scrollToDiv} style={{ color: '#009e7f', fontWeight: 700 }}>
                Read More
              </a>
            </BookDescription>
            <BookMetaTable>
      ...
      <RelatedItems>
        ...
        <Products type={product.type.toLowerCase()} deviceType={deviceType} loadMore={false} fetchLimit={10} />
      </RelatedItems>
    </>
  );
};
