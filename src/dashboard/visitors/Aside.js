            ...
            <Box display="flex">
              <Box flexGrow={1}>
                <Box display="flex" mb="1em">
                  ...
                  <Box flexGrow={1}>
                    <Typography>
                      {translate('resources.customers.fields.firstSeen')}
                    </Typography>
              ...
              <Box flexGrow={1}>
                <Box display="flex" mb="1em">
                  ...
                  <Box flexGrow={1}>
                    <Typography>
                      {translate('resources.customers.fields.lastSeen')}
                    </Typography>
  ...
  return (
    <Card className={classes.card}>
      <CardHeader
        ...
        avatar={
          <Avatar
            aria-label={translate('resources.orders.name', {
              smart_count: 1,
            })}
        ...
        action={<EditButton record={record} basePath="/orders" />}
        title={`${translate('resources.orders.name', {
          smart_count: 1,
        })} #${record.reference}`}
        subheader={
          <>
            ...
            <Typography variant="body2" color="textSecondary">
              {translate('resources.orders.nb_items', {
