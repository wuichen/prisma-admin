            ...
            <CardContent>
              <Box display={{ md: 'block', lg: 'flex' }}>
                <Box flex={2} mr={{ md: 0, lg: '1em' }}>
                  ...
                  <Box display={{ xs: 'block', sm: 'flex' }}>
                    <Box flex={1} mr={{ xs: 0, sm: '0.5em' }}>
                      <TextInput source="firstName" resource="customers" validate={requiredValidate} fullWidth />
                    </Box>
                    <Box flex={1} ml={{ xs: 0, sm: '0.5em' }}>
                      <TextInput source="lastName" resource="customers" validate={requiredValidate} fullWidth />
                    </Box>
                  </Box>
                  <TextInput
                    type="email"
                  ...
                  <Box display={{ xs: 'block', sm: 'flex' }}>
                    <Box flex={1} mr={{ xs: 0, sm: '0.5em' }}>
                      <DateInput source="birthday" resource="customers" fullWidth helperText={false} />
                    </Box>
                  ...
                  <TextInput source="address" resource="customers" multiline fullWidth helperText={false} />
                  <Box display={{ xs: 'block', sm: 'flex' }}>
                    <Box flex={1} mr={{ xs: 0, sm: '0.5em' }}>
                      <TextInput source="zipcode" resource="customers" fullWidth helperText={false} />
                    </Box>
                    <Box flex={2} ml={{ xs: 0, sm: '0.5em' }}>
                      <TextInput source="city" resource="customers" fullWidth helperText={false} />
                    </Box>
                  </Box>
                ...
                <Box flex={1} ml={{ xs: 0, lg: '1em' }} mt={{ xs: '1em', lg: 0 }}>
                  ...
                  <div>
                    <NullableBooleanInput source="hasNewsLetter" resource="customers" />
                  </div>
                </Box>
              </Box>
            </CardContent>
