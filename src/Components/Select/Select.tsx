...
const Select: React.FC<SelectProps> = ({ className, labelText, labelPosition, ...props }) => {
  ...
  const LabelField = labelText && <span className="pickbazar__field-label">{labelText}</span>;
